		...
		rule = _make_rule(
			...
			actions=[
				...
				_action(
					...
					"Mark Valid",
					"Assignment",
					config=[{"target": "doc.department", "operator": "set", "value_template": "Validated"}],
					next_step_if_true="done",
				),
				_action(
					"set_invalid",
		...
		rule = _make_rule(
			...
			actions=[
				...
				_action(
					...
					"Mark Success",
					"Assignment",
					config=[{"target": "doc.department", "operator": "set", "value_template": "ErrorHandled"}],
					next_step_if_true="done",
				),
				_action("done", "Complete", "Stop", operation="Success"),
			],
		...
		rule = _make_rule(
			...
			actions=[
				...
				_action(
					...
					"Mark Processed",
					"Assignment",
					config=[{"target": "doc.department", "operator": "set", "value_template": "BulkProcessed"}],
					next_step_if_true="done",
				),
				_action("done", "Complete", "Stop", operation="Success"),
			],
		...
		rule = _make_rule(
			...
			actions=[
				...
				_action(
					...
					"Set Department",
					"Assignment",
					config=[{"target": "doc.department", "operator": "set", "value_template": "CrossDocLinked"}],
					next_step_if_true="done",
				),
				_action("done", "Complete", "Stop", operation="Success"),
			],
